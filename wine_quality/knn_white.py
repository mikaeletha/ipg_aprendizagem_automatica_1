...
dataset = pandas.read_csv(
    "wine_quality/pre_processed/wine_quality_white_train.csv")
x_train = dataset.drop(columns=['quality'])
t_train = dataset['quality']

test_dataset = pandas.read_csv(
    "wine_quality/pre_processed/wine_quality_white_test.csv")
x_test = test_dataset.drop(columns=['quality'])
t_test = test_dataset['quality']

# Best parameters for wine_quality/pre_processed/wine_quality_white_train.csv:  {'n_neighbors': 25, 'p': 1}
n_neighbors = 25
p = 1
